...
declare module "redux-form-material-ui-old" {
  export class AutoComplete extends React.Component<
    __MaterialUI.AutoCompleteProps<string | React.ReactNode>,
    any
  > {}
  ...
  export class TimePicker extends React.Component<
    __MaterialUI.TimePickerProps,
    any
  > {}
  export class DatePicker extends React.Component<
    __MaterialUI.DatePicker.DatePickerProps,
    any
  > {}
  export class RadioButtonGroup extends React.Component<
    __MaterialUI.Switches.RadioButtonGroupProps,
    any
  > {}
  export class SelectField extends React.Component<
    __MaterialUI.SelectFieldProps,
    any
  > {}
  ...
  export class Toggle extends React.Component<
    __MaterialUI.Switches.ToggleProps,
    any
  > {}
}
